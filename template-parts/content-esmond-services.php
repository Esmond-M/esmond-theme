<?php
/**
 * Template part for displaying single esmond-services post content.
 * Customise this file to control how individual service pages look.
 *
 * @package esmond-theme-portfolio
 */
?>

<article id="post-<?php the_ID(); ?>" <?php post_class( 'em-single-service' ); ?>>
